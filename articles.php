...
<body style="background-color: orange">
	...
	<div class="banner" style="background-image: linear-gradient(-225deg, rgba(0,101,168,0.6) 20%, rgba(0,36,61,0.6) 100%), url('img/logo.jpg'); height: 270px;">
    ...
    <h2> <b style="color: cyan"> A LA UNE ................</b> </h2> <br> <br> <br>

    <a style="color: blue" href="articless.php"> <b> Côte d'Ivoire : Soro sur le coup d'après ? </b></a> <br> <br> <br>
    <a style="color: blue" href="article.php"> <b> L'ouvrage " l'Afrique en marche" présenté au groupe parlementaire PDCI-RDA </b></a> <br> <br> <br>
    <a style="color: blue" href="articlee.php"> <b> CPI : Reprise du procès de Gbagbo et Blé Goudé le 17 Janvier à la CPI </b></a>
